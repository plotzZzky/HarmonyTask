...
export default function NavBar() {
  ...
  const FIND = () => {
    return getToken !== null? (
      <div className="menu-item" onClick={goFind}>
        <a><FontAwesomeIcon icon={faMagnifyingGlass} className='icon-menu' /> Buscar </a>
      </div>
    ) : null
  }
  ...
  const PROFILE = () => {
    return getPath === '/find'? (
      <div className="menu-item" onClick={showEditProfile}>
        <a> <FontAwesomeIcon icon={faUser} /> Perfil </a>
      </div>
    ): null
  }
